...
const Weather=(props)=>(
    ...
    <div className="weather_info">
      ...
      {
        props.temp &&
        <p className="weather__key">Temperature:<span className="weather__value"> {props.temp}</span></p>
      }
      {
        props.humidity &&
      ...
      {
        props.description &&
        <p className="weather__key">Conditon:<span className="weather__value"> {props.description}</span></p>
      }
      {
